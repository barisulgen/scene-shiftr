      ...
      {currentView === 'settings' && (
        <div className="flex flex-col items-center justify-center h-full">
          <div className="flex flex-col items-center gap-3 text-zinc-500">
            ...
            <span className="text-xs text-zinc-600">Settings panel coming soon</span>
          </div>
        </div>
      )}
      ...
      {currentView === 'create' && (
        <div className="flex flex-col items-center justify-center h-full">
          <div className="flex flex-col items-center gap-3 text-zinc-500">
            ...
            <span className="text-sm font-medium text-zinc-400">Create Workspace</span>
            <span className="text-xs text-zinc-600">Workspace creation coming soon</span>
          </div>
        </div>
      )}
      ...
      {currentView === 'edit' && (
        <div className="flex flex-col items-center justify-center h-full">
          <div className="flex flex-col items-center gap-3 text-zinc-500">
            ...
            <span className="text-sm font-medium text-zinc-400">Edit Workspace</span>
            <span className="text-xs text-zinc-600">Edit view coming soon</span>
          </div>
        </div>
      )}
    </main>
